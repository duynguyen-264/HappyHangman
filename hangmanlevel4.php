...
$wordList = [
    "LEMUR", "FOLIAGE", "QUIVER", "MONSOON", "ANTELOPE",
    "CHAMELEON", "MARMOSET"
];
...
<head>
    <meta charset="UTF-8">
    <title>Happy Hangman: Level 4</title>
    <link rel="stylesheet" href="styles.css">
</head>

<body>
    <h1 class = "text1">Level 4</h1>
    <!-- Main app display -->
    <div class="container">
        ...
        <div class="status-container">
            ...
            <?php if ($GAME_WON && isGameComplete()) : ?>
				...
				<div style="text-align:center;">
					<button onclick="window.location.href='hangmanlevel5.php'">Level 5</button><br>
				</div>	
