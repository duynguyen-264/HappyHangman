...
$wordList = [
    "LIANA", "JAGUAR", "ENTANGLED", "TARZAN", "QUETZAL",
    "HELICONIA", "MYRMECOLOGY"
];
...
<head>
    <meta charset="UTF-8">
    <title>Happy Hangman: Level 6</title>
    <link rel="stylesheet" href="styles.css">
</head>

<body>
    <h1 class = "text1">Level 6</h1>
    <!-- Main app display -->
    <div class="container">
        ...
        <div class="status-container">
            ...
            <?php if ($GAME_WON && isGameComplete()) : ?>
				...
				<p style="color: darkgreen; font-size: 25px; text-align: center;">YOU WON!</p>
