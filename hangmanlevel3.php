...
$wordList = [
    "CANOPY", "PANTHER", "BAMBOO", "HUMMINGBIRD", "CHIRP",
    "ORCHID", "GLOOMFUL"
];
...
<head>
    <meta charset="UTF-8">
    <title>Happy Hangman: Level 3</title>
    <link rel="stylesheet" href="styles.css">
</head>

<body>
    <h1 class = "text1">Level 3</h1>
    <!-- Main app display -->
    <div class="container">
        ...
        <div class="status-container">
            ...
            <?php if ($GAME_WON && isGameComplete()) : ?>
				...
				<div style="text-align:center;">
					<button onclick="window.location.href='hangmanlevel4.php'">Level 4</button><br>
				</div>	
